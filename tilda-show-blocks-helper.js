var blocks = {
    ...
    208: ['Две или три кнопки', 'BF102', 'forms'],
    209: ['Строка текста и кнопка', 'BF301', 'forms'],
    210: ['Форма с одним полем для ввода', 'BF201', 'forms'],
    212: ['Ссылки на соцсети', 'SM101'],
    213: ['Обложка с одной или двумя кнопками', 'CR12', 'cover'],
    215: ['Якорная ссылка', 'T173', 'anchor'],
    217: ['Кнопка наверх', 'BF702', 'forms'],
    ...
    268: ['CallbackHunter Виджет', 'T128', 'callback'],
    269: ['JivoSite Виджет', 'T133', 'callback'],
    ...
    288: ['Обложка с полем ввода', 'CR26', 'cover'],
    289: ['Обложка с выделенным текстом', 'CR27', 'cover'],
    292: ['Форма для подписки', 'BF306', 'forms'],
    ...
    312: ['Typeform', 'BF601', 'forms'],
    315: ['Hyper Comments', 'T163', 'comments'],
    316: ['Popup: форма подписки', 'BF501', 'popups'],
    ...
    355: ['Chatra Виджет', 'T138', 'callback'],
    ...
    364: ['Popup: Facebook social plugin', 'SM401'],
    365: ['Popup: VKontakte social plugin', 'SM402'],
    ...
    392: ['Кнопки App Store и Google Play', 'BF801', 'forms'],
    393: ['Кнопка зафиксированная в углу', 'BF701', 'forms'],
    ...
    400: ['Кнопка: показать еще', 'BF703', 'forms'],
    ...
    411: ['Обложка с таймером и формой подписки', 'CR34', 'cover'],
    ...
    430: ['Кнопка (кнопки) с иконкой', 'BF802', 'forms'],
    431: ['Таблица', 'CL46', 'tables'],
    432: ['Кнопка (кнопки) Скачать с уточнением формата', 'BF803', 'forms'],
    433: ['Карта Google или Яндекс и блок контактов', 'CN402A'],
    442: ['Кнопка: иконка и текст со ссылкой', 'BF804', 'forms'],
    ...
    449: ['Кнопки социальных сетей: выровненные по центру экрана и зафиксированные сбоку', 'SM301'],
    ...
    580: ['Блок призыва к действию: заголовок, описание и кнопки', 'BF302', 'forms'],
    581: ['Блок призыва к действию: заголовок, описание, кнопка и фоновое изображение', 'BF303', 'forms'],
    582: ['Фиксированная форма подписки', 'BF907', 'forms'],
    585: ['Текст в раскрывающихся блоках', 'TX16N'],
    588: ['Блок призыва к действию: текст и большая кнопка', 'BF305', 'forms'],
    589: ['Изображение, текст и кнопки в две колонки', 'BF401', 'forms'],
    ...
    651: ['Виджет для заказа обратного звонка', 'BF901', 'callback'],
    653: ['Виджет с формой подписки', 'BF903', 'callback'],
    654: ['Панель для анонса', 'BF906', 'forms'],
    ...
    700: ['Изображение/Youtube видео и форма в двух колонках', 'BF402N', 'forms'],
    ...
    708: ['Виджет для отправки сообщения', 'BF902N', 'callback'],
    ...
    811: ['Форма для приема взносов', 'BF923', 'forms'],
    ...
    828: ['Обложка с расписанием', 'CR37', 'cover'],
    ...
    839: ['Мультилендинг: скрыть/показать блок по Языку пользователя', 'T839', 'multilanding-geolanding'],
    ...
    868: ['HTML-код в попапе', 'T868', 'html'],
...
document.querySelectorAll("iframe").forEach(function (el) {
    ...
    style.innerHTML = `[data-record-type]:hover .recordediticons {
    display: block
}
